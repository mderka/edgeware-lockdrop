...
contract Lockdrop {
    ...
    // Start
    uint256 constant public LOCK_DROP_PERIOD = 1 days * 90; // 3 months
    uint256 constant public LOCK_DROP_FIRST_MONTH = 1 days * 30;
    uint256 constant public LOCK_DROP_SECOND_MONTH = 1 days * 60;
